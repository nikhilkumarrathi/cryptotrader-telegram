This is an unplanned tool that sprouted gradually into something nice and so useful. I was playing with Python and Binance API when realized that there are many things that I check so frequently, wouldn't it be nice to just fire a command from you Phone and get the answer within seconds? Or what about scheduling something to run over and over without having to remember it.
